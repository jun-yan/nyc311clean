...
\begin{figure}[tbp]
  ...
  \caption{Monthly SR counts over years 2022-2023}
...
\begin{figure}[tbp]
  \centering
 	\includegraphics[width = 0.65\textwidth] {computed_fields.pdf}	
...
\subsubsection{Case Study: Homeless Person Assistance}
	...
	\begin{figure}[tbp]
		...
		\caption{Post-Closed resolution\_action\_update\_date \textgreater30 days}
	...
	\begin{figure}[tbp]
		...
		\caption{Post-Closed resolution\_action\_update\_date \textgreater30 days by Agency}
