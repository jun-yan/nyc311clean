...
\texttt{incident address}. We found 88\% of these pairs to be 
...
Table~\ref{tab:summary1} presents a summary of the matching results 
for \texttt{cross\_street\_1} and \texttt{intersection\_street\_1}. As 
the table shows, 88.15\% of the non-blank entries are exact matches.
