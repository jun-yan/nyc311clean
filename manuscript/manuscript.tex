...
trends and observe certain dating anomalies, such as SRs 
closeing trends. This 10-year dataset is approximately 
1.4 GB in size. Instructions on dowloading this file 
from the NYC Open Data Portal are available in the supplemental material.


Additionally, this investigation uses a 2-year dataset for the period
2022-2023, also downloaded on 15 September 2024. This data set 
contains the full 41 columns of 311 SR data and is used to conduct 
more detailed analysis in areas such as data consistency, 
data validity, redundant fields, etc.. The size of this 2-year dataset 
is quite large at 3.7GB. Instructions on downloading this file
 from the NYC Open Data Portal are available in the supplemental material.
...
heightened public awareness  and utilziation of the service. 
