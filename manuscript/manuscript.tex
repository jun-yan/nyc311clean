...
\begin{itemize}
	\item NYC restaurant health inspection violations
...
Section~\ref{sec:trends} we take a look at long-term trends presented 
via a 10-year analysis. Section~\ref{sec:issues} offers a 
...
\section{NYC 311 System History} 
\label{sec:history}
...
annually. Each inquiry is logged as a complaint, a Service Request (SR), 
in the 311 system. Key milestones in the 311 system include:
...
\begin{itemize}
 	...
 	call for each individual City Agency.
      ...
      SRs hit an all-time high of 348,463. Seven of the Top 10 all-time busiest 
      days occur in 2020.
      \item 2021 - 311 System is expanded to include the MTA's city subway system, 
...
and unsanitary conditions. The data is a valuable resource for City
administration and policy-making. The 311 data is publicly accessible through the 
NYC Open Data Portal which provides access to all the data 
sets (approx. 2700) and provides a convenient method for querying, 
grouping, aggregating, geo-mapping, visualization, and exporting 
results. This open data  enables not only governmental transparency 
but empowers researchers, civic developers, and the general public. 

Despite its success, the 311 system faces challenges such as:
...
These and other challenges are addressed by the various 
...
technology support for the open data system. Typically, the data 
will be exported and processed in an external program. The authors found 
this to be the case with the large 311 dataset examined.
...
\section{10-year Analysis \& Trends} 
\label{sec:trends}
As part of this study, we also looked at a 10-year period (2014-2023) to
...
on Christmas Day, 2016, a Sunday. 
...
Thus we can often identify if it is an Agency specific problem, 
or a systemic issue. Although 311 SRs involve 16 different agencies, 
there are six Agencies that comprise 90\% of the complaints.
...
comprising 70\% out of a total of 220 different types.
...
complaints total a full 22\% of all complaint types, which, when consolidated, is the most frequently occurring complaint\_type.
