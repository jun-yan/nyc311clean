...
Of particular note is that several of the \textit{Mostly Empty} fields
are used by only one or two Agencies. Example:
...
and \texttt{cross\_street\_1 \& \_2}. 

And the \textit{Few/None Empty} 
category includes \texttt{created\_date}, \texttt{complaint\_type},
\texttt{agency}, and \texttt{status}. 
...
field illustrating the grouping into the Most, 
Partial, and Few/None categories.
...
\jy{Could refer to cross-platform data format such as Arrow
  \citep{bates2024csv}.}
