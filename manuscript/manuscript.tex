...
\texttt{landmark} \& \texttt{street\_name:} While the \texttt{landmark} field is 
...
indicates a possible misuse of the \texttt{landmark} field as well as
a high level of redundancy.

\texttt{cross\_street\_1} \& \texttt{intersection\_street\_1} and \texttt{cross\_street\_2} 
\& \texttt{intersection\_street\_2}: These two sets of street pairs are used to 
help identify the incident address. We found 88\% of 
these pairs to be duplicates. This duplication  
raises the question of which field-pair should be trusted. It is possible 
that the two street pairs originated from different agencies that used 
different variable names to represent the same information, but no 
documentation exists to clarify this relationship. Without question
these two street-pairs are highly redundant.
