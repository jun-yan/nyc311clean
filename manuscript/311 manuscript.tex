...
\subsubsection{Case Study: Homeless Person Assistance}
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{created_at_noon_chart.png}
...
\begin{table}[H]
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{post_closed_violin.png}
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{postClosedBarChart.png}
...
We can tell where the non-matches occur. It is mostly in DOT, NYPD, and DSNY which represent 90\% of the non-matching values.
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{non_matching_borough_boundaries_chart.png}
...
\end{table}
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{non-matchingcross_street_1andintersection_street_1.png}
	...
	\begin{figure}[H]
		 \centering
		 \includegraphics[scale = 0.65]{non-matchingcross_street_2andintersection_street_2.png}
