...
%% Make sure every package in preamble is used
...
\usepackage{setspace}
\usepackage[width=.95\textwidth, skip=0.1\baselineskip]{caption}
...
\allowdisplaybreaks % \usepackage{rotating}
...
% \AddToHook{cmd/section/before}{\clearpage} % will remove
