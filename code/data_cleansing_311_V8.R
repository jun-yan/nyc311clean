...
ggsave(chart_path, plot = SR_by_agency, width = 10, height = 8)
...
ggsave(chart_path, plot = complaintDataChart, width = 12, height = 8)
...
ggsave(chart_path, plot = incident_zipChart, width = 10, height = 8)
...
ggsave(chart_path, plot = zip_codesChart, width = 10, height = 8)
