...
#########################################################################
# Figshare direct download link (Replace with your actual URL)
figshare_url <- c("https://figshare.com/ndownloader/files/52512689")

# Download dataset from Figshare
temp_file <- tempfile(fileext = ".rds")
download.file(figshare_url, temp_file, mode = "wb")

# Load dataset
cleaned_data <- readRDS(temp_file)
setDT(dataset)  # Ensure it's a data.table
