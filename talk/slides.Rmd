---
title: "On Principles for Government Open Data Curation"
date: "June 15, 2023 @ GASP23"
...
header-includes:
  ...
  - \AtBeginDocument
    {
<<<<<<< Updated upstream
    \title[NYC 311 Requests]{On Principles for Government Open Data Curation:\\A Case Study with NYC 311 Servece Requests}
=======
    \title[NYC 311 Requests]{On Principles for Government Open Data Curation\\A Case Study with NYC 311 Service Requests}
>>>>>>> Stashed changes
...
- Open Data is viewed as a right for all [@janssen2012benefits; @wang2016adoption].
- Cities lead open data efforts wtih >50 cities with formal programs.
- NYC is a forerunner with Open Data Law in 2012 [@zuiderwijk2014open].
...
- Used by many researchers:
    + Health [@cantor2018facets, shankar2021data]
    + Smart city [@neves2020impacts]
    + Transportation [@gerte2019understanding]
...
- NYC 311 is a unified frontline for all service requests to the NYC government agents.
- The data was used in STAT 3255/5255 Introduction to Data Science at UConn, with student presentations at 2022/2023 NYC Open Data Week.
- In this study, we exported 1-31 March 2023 311 SRs for analysis (~251K records).
- Data curation is critical for open data such as the 311 SRs [@witt2009constructing; @borgman2012conundrum; @mclure2014data; @barns2016mine; @hart2016ten; @beheshti2019datasynapse; @shankar2021data].
- Issues
    - Validity
	- Efficiency
...
nrow(badZipcode)  # mostly invalid! One possibility: debt collectors
```
...
"Due to pandemic call handling modifications, the ‘Open Data Channel Type’ values may not accurately indicate the channel the Service Request was submitted in for the period starting March 2020."
...
## Redundant Data: Agence, Agency Name, and Other Categorical Variables
```{r agent}
head(d311[, c("agency", "agency_name")])
head(sort(table(d311$complaint_type), decreasing = TRUE)) # 174 types
```
...
- Open data curation protocol

- Open data analytic portal
